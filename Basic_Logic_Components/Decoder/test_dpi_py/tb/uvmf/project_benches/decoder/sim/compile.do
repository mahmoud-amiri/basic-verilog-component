...
exec gcc -c -o $env(UVMF_PROJECT_DIR)/../../../dpi/general_dpi_wrapper.o $env(UVMF_PROJECT_DIR)/../../../dpi/dpi_wrapper_code.c -L "C:/Users/mamir/AppData/Local/Programs/Python/Python312/libs" -I "C:/Users/mamir/AppData/Local/Programs/Python/Python312/include"
exec gcc -shared -o $env(UVMF_PROJECT_DIR)/../../../dpi/general_dpi_wrapper.dll $env(UVMF_PROJECT_DIR)/../../../dpi/general_dpi_wrapper.o -L "C:/Users/mamir/AppData/Local/Programs/Python/Python312/libs" -I "C:/Users/mamir/AppData/Local/Programs/Python/Python312/include" -lpython312
...
vlog -sv -timescale 1ps/1ps -suppress 2223,2286 $env(UVMF_PROJECT_DIR)/../../../../hdl/decoder.v
...
###################################################################
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/decoder_in_pkg/compile.do
do $env(UVMF_VIP_LIBRARY_HOME)/interface_packages/decoder_out_pkg/compile.do

###################################################################
## UVMF ENVIRONMENT COMPILATION
###################################################################
do $env(UVMF_VIP_LIBRARY_HOME)/environment_packages/decoder_env_pkg/compile.do

###################################################################
## UVMF BENCHES COMPILATION
###################################################################
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/parameters $env(UVMF_PROJECT_DIR)/tb/parameters/decoder_parameters_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/sequences $env(UVMF_PROJECT_DIR)/tb/sequences/decoder_sequences_pkg.sv
vlog -sv -timescale 1ps/1ps -suppress 2223 -suppress 2286 +incdir+$env(UVMF_PROJECT_DIR)/tb/tests $env(UVMF_PROJECT_DIR)/tb/tests/decoder_tests_pkg.sv
...
### SIMULATION COMMAND
####################################################################
#vsim -c -sv_lib decoder optimized_batch_top_tb -do "run -all; quit"
