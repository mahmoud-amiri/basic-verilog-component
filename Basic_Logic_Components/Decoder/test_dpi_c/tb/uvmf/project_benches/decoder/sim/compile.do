...
####################################################################
## Compile the C code to create a shared library for DPI
#exec gcc -c -fPIC -o decoder.o $env(UVMF_PROJECT_DIR)/c_src/decoder.c
#exec gcc -shared -o decoder.so decoder.o

###################################################################
## COMPILE C CODE AND CREATE SHARED LIBRARY
###################################################################
# Compile the C code to create a DLL for DPI
exec gcc -c -o $env(UVMF_PROJECT_DIR)/c_src/decoder.o $env(UVMF_PROJECT_DIR)/c_src/decoder.c
exec gcc -shared -o $env(UVMF_PROJECT_DIR)/c_src/decoder.dll $env(UVMF_PROJECT_DIR)/c_src/decoder.o
